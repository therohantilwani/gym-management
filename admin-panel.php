...
<option value="mr1">6:00am to 8:00am</option>
<option value="mr2">8:00am to 10:00am</option>
<option value="ev1">6:00pm to 8:00pm</option>
<option value="ev2">8:00pm to 10:00pm</option>



  <input type="submit" class="btn btn-success" name="pat_submit" value="Register">                  <a href="func.php" class="btn btn-light"></a>
