...
if(isset($_POST['pat_submit']))
{
    ...
    $query="insert into doctorapp(fname,lname,email,contact,docapp, timeslot)values('$fname','$lname','$email','$contact','$docapp','$timeslot')";
     $result=mysqli_query($con,$query);

     $indexf=fopen("num.txt","a") or die("Unable to open file!");
 ...
 function get_patient_details(){
    ...
    if ($timeslot=="mr1")
        $timeslot="6:00am to 8:00am";

    else if ($timeslot=="mr2")
        $timeslot="8:00am to 10:00am";

    else if ($timeslot=="ev1")
        $timeslot="6:00pm to 8:00pm";

    else if ($timeslot=="ev2")
        $timeslot="8:00pm to 10:00pm";
